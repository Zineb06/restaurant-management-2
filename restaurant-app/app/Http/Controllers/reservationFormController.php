...
class reservationFormController extends Controller
{
    public function index() : View 
    {
        ...
        return view('reservationForm.createReservation')->with('tables', $tables)->with('clients', $clients);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect('reservationForm.createReservation')->with('add_message', 'Reservation Addedd!');
    }
